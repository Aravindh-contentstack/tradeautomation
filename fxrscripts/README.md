...
Four more scripts provide equilibrium visualizations for the 4H and H1 timeframes:
- [`h4_swing_premium_discount.py`](h4_swing_premium_discount.py) (orange)
- [`h4_internal_premium_discount.py`](h4_internal_premium_discount.py) (cyan)
- [`h1_swing_premium_discount.py`](h1_swing_premium_discount.py) (orange)
- [`h1_internal_premium_discount.py`](h1_internal_premium_discount.py) (cyan)
